...
#define kClientIDRR @"922600604850-cckt858imi6fdqoc2p0pugpffvhdhvbg.apps.googleusercontent.com" // Your application's client ID
...
- (void)initialize {
	if (self.signIn == nil) {
		...
		self.signIn.clientID = kClientIDRR;
