...
-(id)init {
    ...
    if (self) {
        ...
        _subtitleLabel.font = [UIFont fontWithName:@"Arial" size:13];
        ...
        _topButton.titleLabel.font = [UIFont fontWithName:@"Arial" size:13];
        ...
        [_topButton.layer setCornerRadius:3];
        ...
        _bottomButton.titleLabel.font = [UIFont fontWithName:@"Arial" size:13];
        [_bottomButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_bottomButton.layer setCornerRadius:3];
